# This Makefile is for the PGObject::Util::Replication::Slot extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/PGObject/Util/Replication/Slot.pm]
...
#     PL_FILES => {  }
#     PREREQ_PM => { Moo=>q[0], Test::More=>q[0], DBI=>q[0], DBD::Pg=>q[0] }
#     TEST_REQUIRES => {  }
...
MAKE = make
FULLEXT = PGObject/Util/Replication/Slot
BASEEXT = Slot
PARENT_NAME = PGObject::Util::Replication
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/PGObject/Util/Replication/Slot.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/PGObject/Util/Replication
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/PGObject/Util/Replication
...
TO_INST_PM = lib/PGObject/Util/Replication/Slot.pm

PM_TO_BLIB = lib/PGObject/Util/Replication/Slot.pm \
...
DISTVNAME = PGObject-Util-Replication-Slot-0.020000
...
manifypods : pure_all  \
	lib/PGObject/Util/Replication/Slot.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/PGObject/Util/Replication/Slot.pm $(INST_MAN3DIR)/PGObject::Util::Replication::Slot.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Manage and Monitor Replication Slots'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: PGObject-Util-Replication-Slot' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'version: 0.020000' >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) '{' > META_new.json
	$(NOECHO) $(ECHO) '   "abstract" : "Manage and Monitor Replication Slots",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "PGObject-Util-Replication-Slot",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   "version" : "0.020000"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Manage and Monitor Replication Slots</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/PGObject/Util/Replication/Slot.pm blib/lib/PGObject/Util/Replication/Slot.pm 
